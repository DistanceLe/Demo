...
-(void)handlerPanAction:(UIPanGestureRecognizer*)pan{
    StatusBlock tempBlock=[self.handlerDictionary objectForKey:@"pan"];
    if (tempBlock) {
        tempBlock(pan, self);
    }
}
...
-(void)handlerTapAction:(UITapGestureRecognizer*)tap{
    StatusBlock tempBlock=[self.handlerDictionary objectForKey:@"tap"];
    if (tempBlock) {
        tempBlock(tap, self);
    }
}
-(void)handlerDoubleTapAction:(UITapGestureRecognizer*)tap{
    StatusBlock tempBlock=[self.handlerDictionary objectForKey:@"doubleTap"];
    if (tempBlock) {
        tempBlock(tap, self);
    }
}
